...
# Other
pacman -S brightnessctl btrfs-progs xdg-user-dirs fastfetch qbittorrent tor torsocks ffmpeg ffmpegthumbnailer btop grim slurp wl-clipboard unzip unrar 7zip fzf
```
